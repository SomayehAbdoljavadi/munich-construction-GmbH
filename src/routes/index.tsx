...
function HomePage() {
  ...
  return (
    <>
      ...
      {/* SLIDE 3: CONTACT + LOCATION (with footer) */}
      <section id="contact" className="bg-ink text-white relative overflow-hidden min-h-screen snap-start flex flex-col">
        <div aria-hidden className="absolute inset-0 opacity-[0.04] pointer-events-none" style={{
          backgroundImage: "radial-gradient(circle at 1px 1px, white 1px, transparent 0)",
          backgroundSize: "32px 32px",
        }} />
        <div className="relative flex-1 flex items-center py-20 md:py-24">
          <div className="max-w-7xl mx-auto px-5 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 w-full">
