...
export const HOME_SERVICES_I18N: ServiceDetailI18n[] = [
  {
    ...
    h1: { de: "Brandschutz in München und Bayern", en: "Fire Protection in Munich and Bavaria" },
    subtitle: {
      de: "Passiver Brandschutz mit Sitz in München – tätig in ganz Bayern",
      en: "Passive fire protection based in Munich – working throughout Bavaria",
    },
    intro: {
      de: "Mit Sitz in München führen wir passiven Brandschutz für Neubau und Bestand aus: Brandabschottungen, Brandschutzbekleidungen und feuerwiderstandsfähige Wand- und Deckensysteme – dokumentiert und in ganz Bayern.",
      en: "Based in Munich, we carry out passive fire protection for new and existing buildings: firestopping, fire-rated linings and fire-resistant wall and ceiling systems – documented and throughout Bavaria.",
    },
    paragraph: {
    ...
    whyUs: WHY_US,
    metaTitle: {
      de: "Brandschutz in München und Bayern | Munich Construction",
      en: "Fire Protection in Munich and Bavaria | Munich Construction",
    },
    metaDescription: {
      de: "Passiver Brandschutz mit Sitz in München: Brandabschottungen, Brandschutzbekleidungen und feuerwiderstandsfähige Wände und Decken in ganz Bayern.",
      en: "Munich-based passive fire protection: firestopping, fire-rated linings and fire-resistant walls and ceilings throughout Bavaria.",
    },
    applications: [
      { de: "Hotels und Beherbergungsbetriebe", en: "Hotels and hospitality buildings" },
      { de: "Büro- und Gewerbegebäude", en: "Office and commercial buildings" },
      { de: "Bestandsgebäude bei Umbau, Sanierung oder Nutzungsänderung", en: "Existing buildings during refits, refurbishment or change of use" },
      { de: "Neubauten mit Anforderungen an Feuerwiderstand", en: "New builds with fire resistance requirements" },
    ],
    process: [
      { title: { de: "Anfrage", en: "Enquiry" }, text: { de: "Sie senden uns Ihr Anliegen – idealerweise mit vorhandenem Brandschutzkonzept, Plänen und Fotos.", en: "You send us your request – ideally with any existing fire protection concept, plans and photos." } },
      { title: { de: "Bestandsaufnahme vor Ort", en: "On-site assessment" }, text: { de: "Wir prüfen Durchführungen, Wände und Decken und klären die Anforderungen aus Konzept und Auflagen.", en: "We inspect penetrations, walls and ceilings and clarify requirements from the concept and permits." } },
      { title: { de: "Angebot", en: "Quotation" }, text: { de: "Sie erhalten ein Angebot mit den erforderlichen Maßnahmen und Systemen.", en: "You receive a quotation listing the required measures and systems." } },
      { title: { de: "Ausführung", en: "Execution" }, text: { de: "Fachgerechte Umsetzung mit zugelassenen Systemen, abgestimmt mit allen Gewerken.", en: "Professional execution with approved systems, coordinated with all trades." } },
      { title: { de: "Dokumentation und Übergabe", en: "Documentation and handover" }, text: { de: "Dokumentation der ausgeführten Maßnahmen für Bauherrn, Sachverständige und Behörden.", en: "Documentation of the completed measures for the client, experts and authorities." } },
    ],
    costFactors: [
      { de: "Anzahl und Art der Wand- und Deckendurchführungen", en: "Number and type of wall and slab penetrations" },
      { de: "Geforderte Feuerwiderstandsklasse", en: "Required fire resistance rating" },
      { de: "Zustand und Zugänglichkeit des Bestands", en: "Condition and accessibility of the existing building" },
      { de: "Umfang der erforderlichen Dokumentation", en: "Scope of the required documentation" },
      { de: "Arbeiten im laufenden Betrieb, z. B. in Hotels", en: "Work during ongoing operation, e.g. in hotels" },
    ],
    quoteChecklist: [
      { de: "Adresse bzw. Ort des Objekts in Bayern", en: "Address or location of the property in Bavaria" },
      { de: "Vorhandenes Brandschutzkonzept oder behördliche Auflagen", en: "Existing fire protection concept or official requirements" },
      { de: "Pläne sowie Fotos der betroffenen Bereiche", en: "Plans and photos of the areas concerned" },
      { de: "Nutzung des Gebäudes (z. B. Hotel, Büro, Wohnen)", en: "Use of the building (e.g. hotel, office, residential)" },
      { de: "Gewünschter Zeitraum für die Ausführung", en: "Preferred timeframe for the works" },
    ],
  },
  {
    slug: "trockenbau",
    ...
    h1: { de: "Trockenbau in München und Bayern", en: "Drywall Construction in Munich and Bavaria" },
    subtitle: {
      de: "Trockenbaufirma mit Sitz in München – tätig in ganz Bayern",
      en: "Drywall contractor based in Munich – working throughout Bavaria",
    },
    intro: {
      de: "Als Trockenbaufirma mit Sitz in München setzen wir Trennwände, abgehängte Decken, Vorsatzschalen sowie Schall- und Brandschutzkonstruktionen für Büro, Gewerbe, Hotels und Wohnbau um – in München und in ganz Bayern.",
      en: "As a drywall contractor based in Munich, we build partitions, suspended ceilings, furring walls and acoustic and fire-rated assemblies for offices, commercial space, hotels and residential projects – in Munich and throughout Bavaria.",
    },
    paragraph: {
    ...
    whyUs: WHY_US,
    metaTitle: {
      de: "Trockenbau in München und Bayern | Munich Construction",
      en: "Drywall Construction in Munich and Bavaria | Munich Construction",
    },
    metaDescription: {
      de: "Trockenbaufirma mit Sitz in München: Trennwände, Decken, Vorsatzschalen, Schall- und Brandschutz für Büro, Gewerbe und Wohnbau in ganz Bayern.",
      en: "Munich-based drywall contractor: partitions, ceilings, furring walls, acoustic and fire-rated assemblies for offices, commercial and residential projects across Bavaria.",
    },
    applications: [
      { de: "Büro- und Gewerbeflächen: Raumaufteilung, Trennwände und abgehängte Decken", en: "Office and commercial space: layouts, partitions and suspended ceilings" },
      { de: "Hotels und Beherbergungsbetriebe, auch mit Brandschutzanforderungen", en: "Hotels and hospitality buildings, including fire protection requirements" },
      { de: "Wohnungen und Bestandsgebäude bei Umbau und Sanierung", en: "Apartments and existing buildings during refits and refurbishment" },
      { de: "Installationswände und Verkleidungen für Haustechnik", en: "Service-cavity walls and linings for building services" },
    ],
    process: [
      { title: { de: "Anfrage", en: "Enquiry" }, text: { de: "Sie schildern Ihr Vorhaben per Formular, Telefon oder WhatsApp – gern mit Plänen und Fotos.", en: "You describe your project via form, phone or WhatsApp – ideally with plans and photos." } },
      { title: { de: "Besichtigung und Aufmaß", en: "Site visit and survey" }, text: { de: "Wir prüfen die Situation vor Ort, klären Anforderungen an Schall- und Brandschutz und nehmen Maß.", en: "We assess the site, clarify acoustic and fire protection requirements and take measurements." } },
      { title: { de: "Angebot", en: "Quotation" }, text: { de: "Sie erhalten ein nachvollziehbares Angebot mit den vereinbarten Leistungen und Oberflächenqualitäten.", en: "You receive a transparent quotation listing the agreed scope and finish qualities." } },
      { title: { de: "Ausführung", en: "Execution" }, text: { de: "Unser Team setzt die Arbeiten sauber und abgestimmt mit den übrigen Gewerken um.", en: "Our team carries out the works cleanly and coordinated with the other trades." } },
      { title: { de: "Abnahme und Übergabe", en: "Acceptance and handover" }, text: { de: "Gemeinsame Abnahme der Leistungen und Übergabe der fertigen Flächen.", en: "Joint acceptance of the works and handover of the finished areas." } },
    ],
    costFactors: [
      { de: "Fläche und Anzahl der Wände, Decken und Verkleidungen", en: "Area and number of walls, ceilings and linings" },
      { de: "Anforderungen an Schall-, Wärme- und Brandschutz", en: "Acoustic, thermal and fire protection requirements" },
      { de: "Gewünschte Oberflächenqualität (Q1–Q4)", en: "Required surface quality (Q1–Q4)" },
      { de: "Raumhöhen, Zugänglichkeit und Zustand des Bestands", en: "Room heights, access and condition of the existing building" },
      { de: "Einbauten wie Türen, Revisionsöffnungen oder Installationen", en: "Built-in elements such as doors, access panels or services" },
    ],
    quoteChecklist: [
      { de: "Adresse bzw. Ort des Objekts in Bayern", en: "Address or location of the property in Bavaria" },
      { de: "Grundriss oder Skizze mit ungefähren Maßen", en: "Floor plan or sketch with approximate dimensions" },
      { de: "Fotos der betroffenen Räume", en: "Photos of the rooms concerned" },
      { de: "Anforderungen an Schall- oder Brandschutz, falls bekannt", en: "Acoustic or fire protection requirements, if known" },
      { de: "Gewünschter Zeitraum für die Ausführung", en: "Preferred timeframe for the works" },
    ],
  },
  {
