...
export const BERATUNG = {
  ...
  slotTaken: {
    de: "Dieser Termin ist nicht mehr verfügbar. Bitte wählen Sie eine andere Uhrzeit.",
    en: "This appointment is no longer available. Please choose another time.",
  },
  noSlots: {
  ...
  emailPending: {
    de: "Ihr Termin wurde reserviert. Die Bestätigungs-E-Mail kann sich verzögern.",
    en: "Your appointment has been reserved. The confirmation email may arrive with a delay.",
  },
  bookingFailure: {
...
export const BERATUNG_FAQ: Array<{ q: L; a: L }> = [
  ...
  },
  {
    ...
    a: {
      de: "Wir arbeiten bayernweit – von unseren Standorten in der Blütenstraße 21 und der Heiterwanger Straße 30 in München.",
      en: "We work throughout Bavaria — from our locations at Blütenstraße 21 and Heiterwanger Straße 30 in Munich.",
    },
  },
];
